...
function Switch({ value, defaultCase = null, cases }) {
  if (value == null)
    return null;
  return /* @__PURE__ */ y(k, null, cases[value] != null ? cases[value] : defaultCase);
}
...
function Options(props) {
  return /* @__PURE__ */ y("div", null, /* @__PURE__ */ y("h1", null, "It feels like... options?"), /* @__PURE__ */ y("a", {
    href: "#home"
  }, "go to home"));
}
...
function App() {
  return /* @__PURE__ */ y("main", null, /* @__PURE__ */ y(Header, {
    ...
    value: useRoute(),
    defaultCase: /* @__PURE__ */ y(Home, {
      default: true,
      path: "/home"
    }),
    cases: {
      "#options": /* @__PURE__ */ y(Options, {
        path: "/options"
      })
    }
  }));
