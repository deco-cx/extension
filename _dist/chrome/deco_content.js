...
function d(n2, t22, i22, o2, r22) {
  var f22 = { type: n2, props: t22, key: i22, ref: o2, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, __h: null, constructor: void 0, __v: null == r22 ? ++u : r22 };
...
function x() {
  var n2, l22, u22, t22, o2, r22, e22, c22, s2;
  for (i.sort(f); n2 = i.shift(); )
    n2.__d && (l22 = i.length, t22 = void 0, o2 = void 0, r22 = void 0, c22 = (e22 = (u22 = n2).__v).__e, (s2 = u22.__P) && (t22 = [], o2 = [], (r22 = v({}, e22)).__v = e22.__v + 1, L(s2, e22, r22, u22.__n, void 0 !== s2.ownerSVGElement, null != e22.__h ? [c22] : null, t22, null == c22 ? g(e22) : c22, e22.__h, o2), M(t22, e22, o2), e22.__e != c22 && m(e22)), i.length > l22 && i.sort(f));
  x.__r = 0;
}
function P(n2, l22, u22, t22, i22, o2, r22, f22, e22, a22, v22) {
  var p2, y2, _2, b22, g22, m22, w22, x2, P2, S2, H2 = 0, I2 = t22 && t22.__k || s, T2 = I2.length, j22 = T2, z2 = l22.length;
  for (u22.__k = [], p2 = 0; p2 < z2; p2++)
    null != (b22 = u22.__k[p2] = null == (b22 = l22[p2]) || "boolean" == typeof b22 || "function" == typeof b22 ? null : "string" == typeof b22 || "number" == typeof b22 || "bigint" == typeof b22 ? d(null, b22, null, null, b22) : h(b22) ? d(k, { children: b22 }, null, null, null) : b22.__b > 0 ? d(b22.type, b22.props, b22.key, b22.ref ? b22.ref : null, b22.__v) : b22) && (b22.__ = u22, b22.__b = u22.__b + 1, -1 === (x2 = A(b22, I2, w22 = p2 + H2, j22)) ? _2 = c : (_2 = I2[x2] || c, I2[x2] = void 0, j22--), L(n2, b22, _2, i22, o2, r22, f22, e22, a22, v22), g22 = b22.__e, (y2 = b22.ref) && _2.ref != y2 && (_2.ref && O(_2.ref, null, b22), v22.push(y2, b22.__c || g22, b22)), null != g22 && (null == m22 && (m22 = g22), S2 = !(P2 = _2 === c || null === _2.__v) && x2 === w22, P2 ? -1 == x2 && H2-- : x2 !== w22 && (x2 === w22 + 1 ? (H2++, S2 = true) : x2 > w22 ? j22 > z2 - w22 ? (H2 += x2 - w22, S2 = true) : H2-- : H2 = x2 < w22 && x2 == w22 - 1 ? x2 - w22 : 0), w22 = p2 + H2, S2 = S2 || x2 == p2 && !P2, "function" != typeof b22.type || x2 === w22 && _2.__k !== b22.__k ? "function" == typeof b22.type || S2 ? void 0 !== b22.__d ? (e22 = b22.__d, b22.__d = void 0) : e22 = g22.nextSibling : e22 = $(n2, g22, e22) : e22 = C(b22, e22, n2), "function" == typeof u22.type && (u22.__d = e22)));
  for (u22.__e = m22, p2 = T2; p2--; )
...
function C(n2, l22, u22) {
  for (var t22, i22 = n2.__k, o2 = 0; i22 && o2 < i22.length; o2++)
    (t22 = i22[o2]) && (t22.__ = n2, l22 = "function" == typeof t22.type ? C(t22, l22, u22) : $(u22, t22.__e, l22));
  return l22;
}
function $(n2, l22, u22) {
...
function A(n2, l22, u22, t22) {
  var i22 = n2.key, o2 = n2.type, r22 = u22 - 1, f22 = u22 + 1, e22 = l22[u22];
  if (null === e22 || e22 && i22 == e22.key && o2 === e22.type)
    return u22;
  if (t22 > (null != e22 ? 1 : 0))
    for (; r22 >= 0 || f22 < l22.length; ) {
      if (r22 >= 0) {
        if ((e22 = l22[r22]) && i22 == e22.key && o2 === e22.type)
          return r22;
        r22--;
      }
      if (f22 < l22.length) {
        if ((e22 = l22[f22]) && i22 == e22.key && o2 === e22.type)
          return f22;
        f22++;
      }
    }
...
function H(n2, l22, u22, t22, i22) {
  var o2;
  for (o2 in u22)
    "children" === o2 || "key" === o2 || o2 in l22 || T(n2, o2, null, u22[o2], t22);
  for (o2 in l22)
    i22 && "function" != typeof l22[o2] || "children" === o2 || "key" === o2 || "value" === o2 || "checked" === o2 || u22[o2] === l22[o2] || T(n2, o2, l22[o2], u22[o2], t22);
}
...
function T(n2, l22, u22, t22, i22) {
  ...
  n:
    if ("style" === l22)
      ...
      o2 = l22 !== (l22 = l22.replace(/Capture$/, "")), l22 = l22.toLowerCase() in n2 ? l22.toLowerCase().slice(2) : l22.slice(2), n2.l || (n2.l = {}), n2.l[l22 + o2] = u22, u22 ? t22 || n2.addEventListener(l22, o2 ? z : j, o2) : n2.removeEventListener(l22, o2 ? z : j, o2);
...
function L(n2, u22, t22, i22, o2, r22, f22, e22, c22, s2) {
  var a22, p2, y2, d2, _2, g22, m22, w22, x2, C2, S2, $2, A2, H2, I2, T2 = u22.type;
  ...
  try {
    n:
      if ("function" == typeof T2) {
        if (w22 = u22.props, x2 = (a22 = T2.contextType) && i22[a22.__c], C2 = a22 ? x2 ? x2.props.value : a22.__ : i22, t22.__c ? m22 = (p2 = u22.__c = t22.__c).__ = p2.__E : ("prototype" in T2 && T2.prototype.render ? u22.__c = p2 = new T2(w22, C2) : (u22.__c = p2 = new b(w22, C2), p2.constructor = T2, p2.render = B), x2 && x2.sub(p2), p2.props = w22, p2.state || (p2.state = {}), p2.context = C2, p2.__n = i22, y2 = p2.__d = true, p2.__h = [], p2._sb = []), null == p2.__s && (p2.__s = p2.state), null != T2.getDerivedStateFromProps && (p2.__s == p2.state && (p2.__s = v({}, p2.__s)), v(p2.__s, T2.getDerivedStateFromProps(w22, p2.__s))), d2 = p2.props, _2 = p2.state, p2.__v = u22, y2)
          ...
          if (null == T2.getDerivedStateFromProps && w22 !== d2 && null != p2.componentWillReceiveProps && p2.componentWillReceiveProps(w22, C2), !p2.__e && (null != p2.shouldComponentUpdate && false === p2.shouldComponentUpdate(w22, p2.__s, C2) || u22.__v === t22.__v)) {
          ...
          null != p2.componentWillUpdate && p2.componentWillUpdate(w22, p2.__s, C2), null != p2.componentDidUpdate && p2.__h.push(function() {
            p2.componentDidUpdate(d2, _2, g22);
          });
        }
        if (p2.context = C2, p2.props = w22, p2.__P = n2, p2.__e = false, $2 = l.__r, A2 = 0, "prototype" in T2 && T2.prototype.render) {
        ...
        p2.state = p2.__s, null != p2.getChildContext && (i22 = v(v({}, i22), p2.getChildContext())), y2 || null == p2.getSnapshotBeforeUpdate || (g22 = p2.getSnapshotBeforeUpdate(d2, _2)), P(n2, h(I2 = null != a22 && a22.type === k && null == a22.key ? a22.props.children : a22) ? I2 : [I2], u22, t22, i22, o2, r22, f22, e22, c22, s2), p2.base = u22.__e, u22.__h = null, p2.__h.length && f22.push(p2), m22 && (p2.__E = p2.__ = null);
      } else
        null == r22 && u22.__v === t22.__v ? (u22.__k = t22.__k, u22.__e = t22.__e) : u22.__e = N(t22.__e, u22, t22, i22, o2, r22, f22, c22, s2);
...
function N(l22, u22, t22, i22, o2, r22, f22, e22, s2) {
  var a22, v22, y2, d2 = t22.props, _2 = u22.props, k22 = u22.type, b22 = 0;
  if ("svg" === k22 && (o2 = true), null != r22) {
  ...
  if (null == l22) {
    ...
    l22 = o2 ? document.createElementNS("http://www.w3.org/2000/svg", k22) : document.createElement(k22, _2.is && _2), r22 = null, e22 = false;
  }
  if (null === k22)
    d2 === _2 || e22 && l22.data === _2 || (l22.data = _2);
  else {
    if (r22 = r22 && n.call(l22.childNodes), v22 = (d2 = t22.props || c).dangerouslySetInnerHTML, y2 = _2.dangerouslySetInnerHTML, !e22) {
      if (null != r22)
        for (d2 = {}, b22 = 0; b22 < l22.attributes.length; b22++)
          d2[l22.attributes[b22].name] = l22.attributes[b22].value;
      (y2 || v22) && (y2 && (v22 && y2.__html == v22.__html || y2.__html === l22.innerHTML) || (l22.innerHTML = y2 && y2.__html || ""));
    }
    if (H(l22, _2, d2, o2, e22), y2)
      u22.__k = [];
    else if (P(l22, h(b22 = u22.props.children) ? b22 : [b22], u22, t22, i22, o2 && "foreignObject" !== k22, r22, f22, r22 ? r22[0] : t22.__k && g(t22, 0), e22, s2), null != r22)
      for (b22 = r22.length; b22--; )
        null != r22[b22] && p(r22[b22]);
    e22 || ("value" in _2 && void 0 !== (b22 = _2.value) && (b22 !== l22.value || "progress" === k22 && !b22 || "option" === k22 && b22 !== d2.value) && T(l22, "value", b22, d2.value, false), "checked" in _2 && void 0 !== (b22 = _2.checked) && b22 !== l22.checked && T(l22, "checked", b22, d2.checked, false));
  }
  return l22;
}
...
function q(n2, u22, t22) {
  ...
  if (i22 = n2.__k)
    for (o2 = 0; o2 < i22.length; o2++)
      i22[o2] && q(i22[o2], u22, t22 || "function" != typeof n2.type);
...
n = s.slice, l = { __e: function(n2, l22, u22, t22) {
  for (var i22, o2, r22; l22 = l22.__; )
    if ((i22 = l22.__c) && !i22.__)
      try {
        if ((o2 = i22.constructor) && null != o2.getDerivedStateFromError && (i22.setState(o2.getDerivedStateFromError(n2)), r22 = i22.__d), null != i22.componentDidCatch && (i22.componentDidCatch(n2, t22 || {}), r22 = i22.__d), r22)
          return i22.__E = i22;
      } catch (l3) {
        n2 = l3;
      }
...
mod_exports.default.runtime.onMessage.addListener(
